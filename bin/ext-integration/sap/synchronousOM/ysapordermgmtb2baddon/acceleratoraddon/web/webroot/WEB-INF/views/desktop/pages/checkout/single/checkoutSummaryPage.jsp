...
<%@ taglib prefix="addon-checkout" tagdir="/WEB-INF/tags/addons/ysapordermgmtb2baddon/desktop/checkout" %>
...
<addon-checkout-single:summaryFlow cartData="${cartData}"/>	
	...
	<div id="placeOrder" class="clearfix">
		...
		<div id="checkoutOrderDetails" >
			<addon-checkout:summaryCartItems cartData="${cartData}"/>
			<div class="span-16 ">
