 ...
 *  
 */
package de.hybris.platform.ytelcoacceleratorcore.constraints;
...
{
	String message() default "{de.hybris.platform.ytelcoacceleratorcore.constraints.ClassificationNotBlank.message}";
