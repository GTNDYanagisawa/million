...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			de.hybris.platform.ycommercewebservices.jalo.expressupdate.cron.ProductExpressUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			de.hybris.platform.ycommercewebservices.jalo.expressupdate.cron.OrderStatusUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			de.hybris.platform.ycommercewebservices.jalo.OldCartRemovalCronJob.class,
			null,
			false,
			null,
			false
