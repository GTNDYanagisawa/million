...
/**
 * Validates for CustomerModel if attribute mobileNumber for this model is unique. 
 * Throws CustomerMobileNumberValidateInterceptor if the unique constraint is violated.
 */
