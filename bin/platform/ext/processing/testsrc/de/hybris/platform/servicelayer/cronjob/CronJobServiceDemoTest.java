...
public class CronJobServiceDemoTest extends ServicelayerTransactionalBaseTest
{
	...
	@Test
	public void testGetCronJobFactory()
	{
		...
		final CronJobFactory cronJobFactory = cronJobService.getCronJobFactory(job);
		final CronJobModel cronJob = cronJobFactory.createCronJob(job);

		assertTrue("Incorrect type of the cronJob: '" + cronJob.getCode() + "'. Should be CleanUpCronJobModel, but was: '"
				+ cronJob.getClass().getSimpleName() + "'", cronJob instanceof CleanUpCronJobModel);
	}
