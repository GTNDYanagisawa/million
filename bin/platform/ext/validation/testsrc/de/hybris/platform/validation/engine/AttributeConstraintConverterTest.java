...
public class AttributeConstraintConverterTest
{
	...
	private void checkSinglePatternPojoConstraint(final BeanType bean)
	{
		...
		assertEquals(Boolean.FALSE, field.isIgnoreAnnotations());
