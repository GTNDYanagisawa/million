...
public interface CatalogTypeService
{
	 ...
	 * <ul>
	 * <li>
	 * If the <b>supertypesOnly</b> argument is <b>false</b> : all the types with
	 * {@link ComposedTypeModel#CATALOGITEMTYPE} equal TRUE will be returned.</li>
	 * <li>
	 * If the <b>supertypesOnly</b> argument is <b>true</b> : the method will return all {@link ComposedTypeModel}s which
