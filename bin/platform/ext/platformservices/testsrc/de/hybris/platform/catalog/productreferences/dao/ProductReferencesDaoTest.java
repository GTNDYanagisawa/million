...
public class ProductReferencesDaoTest extends ServicelayerTest
{
	...
	{
		assertThat(productReferencesDao.findAllReferences(product1)).contains(productReference1, productReference5,
				productReference6).hasSize(3);
		assertThat(productReferencesDao.findAllReferences(product2)).contains(productReference1, productReference2,
				productReference5, productReference6).hasSize(4);
		assertThat(productReferencesDao.findAllReferences(product3)).contains(productReference2, productReference4).hasSize(2);
	}
