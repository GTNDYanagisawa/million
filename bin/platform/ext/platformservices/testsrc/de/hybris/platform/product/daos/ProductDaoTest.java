...
@IntegrationTest
public class ProductDaoTest extends ServicelayerTransactionalTest
{
	@Resource
	...
	public void testGetProductsWithStatus() throws Exception
	{
		...
		for (final ProductModel product : onlineProducts)
		{
			...
			if (testCode.equals(product.getCode()))
			{
				...
				product.setOnlineDate(new Date(currentDate.getTime() + 360000));
				product.setOfflineDate(new Date(currentDate.getTime() + 720000));
