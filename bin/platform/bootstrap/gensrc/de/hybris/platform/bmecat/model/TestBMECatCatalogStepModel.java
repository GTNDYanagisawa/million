...
import de.hybris.platform.bmecat.model.BMECatCatalogStepModel;
...
public class TestBMECatCatalogStepModel extends BMECatCatalogStepModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "TestBMECatCatalogStep";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public TestBMECatCatalogStepModel()
	{
		super();
	}
	 ...
	 */
	public TestBMECatCatalogStepModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public TestBMECatCatalogStepModel(final BatchJobModel _batchJob, final String _code, final Integer _sequenceNumber)
	{
		super();
	 ...
	 */
	@Deprecated
	public TestBMECatCatalogStepModel(final BatchJobModel _batchJob, final String _code, final ItemModel _owner, final Integer _sequenceNumber)
	{
		super();
		setBatchJob(_batchJob);
		setCode(_code);
