...
public class BMECatImpExScriptMediaModel extends ImpExMediaModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "BMECatImpExScriptMedia";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public BMECatImpExScriptMediaModel()
	{
		super();
	}
	 ...
	 */
	public BMECatImpExScriptMediaModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public BMECatImpExScriptMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final int _linesToSkip, final boolean _removeOnSuccess)
	{
		super();
	 ...
	 */
	@Deprecated
	public BMECatImpExScriptMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final int _linesToSkip, final ItemModel _owner, final boolean _removeOnSuccess)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
