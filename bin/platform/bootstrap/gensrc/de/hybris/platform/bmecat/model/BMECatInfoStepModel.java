...
/**
 * Generated model class for type BMECatInfoStep first defined at extension bmecat.
 */
@SuppressWarnings("all")
public class BMECatInfoStepModel extends BMECatImportStepModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "BMECatInfoStep";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public BMECatInfoStepModel()
	{
		super();
	}
	 ...
	 */
	public BMECatInfoStepModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public BMECatInfoStepModel(final BatchJobModel _batchJob, final String _code, final Integer _sequenceNumber)
	{
		super();
	 ...
	 */
	@Deprecated
	public BMECatInfoStepModel(final BatchJobModel _batchJob, final String _code, final ItemModel _owner, final Integer _sequenceNumber)
	{
		super();
		setBatchJob(_batchJob);
		setCode(_code);
