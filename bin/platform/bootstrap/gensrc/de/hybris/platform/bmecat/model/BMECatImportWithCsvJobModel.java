...
public class BMECatImportWithCsvJobModel extends ImpExImportJobModel
{
	...
	public final static String _TYPECODE = "BMECatImportWithCsvJob";
	
	/** <i>Generated constant</i> - Attribute key of <code>BMECatImportWithCsvJob.defaultCurrencyMappings</code> attribute defined at extension <code>bmecat</code>. */
	public static final String DEFAULTCURRENCYMAPPINGS = "defaultCurrencyMappings";
	
	/** <i>Generated constant</i> - Attribute key of <code>BMECatImportWithCsvJob.defaultCountryMappings</code> attribute defined at extension <code>bmecat</code>. */
	public static final String DEFAULTCOUNTRYMAPPINGS = "defaultCountryMappings";
	
	/** <i>Generated constant</i> - Attribute key of <code>BMECatImportWithCsvJob.defaultUnitMappings</code> attribute defined at extension <code>bmecat</code>. */
	public static final String DEFAULTUNITMAPPINGS = "defaultUnitMappings";
	
	
	/** <i>Generated variable</i> - Variable of <code>BMECatImportWithCsvJob.defaultCurrencyMappings</code> attribute defined at extension <code>bmecat</code>. */
	private Map<String,CurrencyModel> _defaultCurrencyMappings;
	
	/** <i>Generated variable</i> - Variable of <code>BMECatImportWithCsvJob.defaultCountryMappings</code> attribute defined at extension <code>bmecat</code>. */
	private Map<String,CountryModel> _defaultCountryMappings;
	
	/** <i>Generated variable</i> - Variable of <code>BMECatImportWithCsvJob.defaultUnitMappings</code> attribute defined at extension <code>bmecat</code>. */
	 ...
	 */
	public BMECatImportWithCsvJobModel()
	{
		super();
	}
	 ...
	 */
	public BMECatImportWithCsvJobModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public BMECatImportWithCsvJobModel(final String _code)
	{
		super();
		setCode(_code);
	}
	 ...
	 */
	@Deprecated
	public BMECatImportWithCsvJobModel(final String _code, final Integer _nodeID, final ItemModel _owner)
	{
		super();
		setCode(_code);
		setNodeID(_nodeID);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BMECatImportWithCsvJob.defaultCountryMappings</code> attribute defined at extension <code>bmecat</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BMECatImportWithCsvJob.defaultCurrencyMappings</code> attribute defined at extension <code>bmecat</code>. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BMECatImportWithCsvJob.defaultUnitMappings</code> attribute defined at extension <code>bmecat</code>. 
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BMECatImportWithCsvJob.defaultCountryMappings</code> attribute defined at extension <code>bmecat</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BMECatImportWithCsvJob.defaultCurrencyMappings</code> attribute defined at extension <code>bmecat</code>. 
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>BMECatImportWithCsvJob.defaultUnitMappings</code> attribute defined at extension <code>bmecat</code>. 
	 *  
