...
public class CreditCardPaymentInfoModel extends PaymentInfoModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>CreditCardPaymentInfo.subscriptionId</code> attribute defined at extension <code>payment</code>. */
	private String _subscriptionId;
	
	/** <i>Generated variable</i> - Variable of <code>CreditCardPaymentInfo.issueNumber</code> attribute defined at extension <code>commerceservices</code>. */
	private Integer _issueNumber;
	
	/** <i>Generated variable</i> - Variable of <code>CreditCardPaymentInfo.subscriptionValidated</code> attribute defined at extension <code>acceleratorservices</code>. */
	...
	public Integer getIssueNumber()
	{
		...
		return _issueNumber = getPersistenceContext().getValue(ISSUENUMBER, _issueNumber);
	}
	...
	{
		return toPrimitive( _subscriptionValidated = getPersistenceContext().getValue(SUBSCRIPTIONVALIDATED, _subscriptionValidated));
	}
	...
	{
		_issueNumber = getPersistenceContext().setValue(ISSUENUMBER, value);
	}
	...
	{
		_subscriptionValidated = getPersistenceContext().setValue(SUBSCRIPTIONVALIDATED, toObject(value));
	}
