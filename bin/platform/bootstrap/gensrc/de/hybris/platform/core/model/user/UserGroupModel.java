...
public class UserGroupModel extends PrincipalGroupModel
{
	...
	/**<i>Generated relation code constant for relation <code>BTGAssignToGroupDefinitionGroup</code> defining source attribute <code>BTGAssignToGroup</code> in extension <code>btg</code>.</i>*/
	public final static String _BTGASSIGNTOGROUPDEFINITIONGROUP = "BTGAssignToGroupDefinitionGroup";
	...
	/** <i>Generated constant</i> - Attribute key of <code>UserGroup.BTGAssignToGroup</code> attribute defined at extension <code>btg</code>. */
	public static final String BTGASSIGNTOGROUP = "BTGAssignToGroup";
	...
	/** <i>Generated variable</i> - Variable of <code>UserGroup.restrictions</code> attribute defined at extension <code>cms2</code>. */
	private Collection<CMSUserGroupRestrictionModel> _restrictions;
	
	/** <i>Generated variable</i> - Variable of <code>UserGroup.BTGAssignToGroup</code> attribute defined at extension <code>btg</code>. */
	private Collection<BTGAssignToGroupDefinitionModel> _BTGAssignToGroup;
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>UserGroup.BTGAssignToGroup</code> attribute defined at extension <code>btg</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the BTGAssignToGroup
	 */
	public Collection<BTGAssignToGroupDefinitionModel> getBTGAssignToGroup()
	{
		if (this._BTGAssignToGroup!=null)
		{
			return _BTGAssignToGroup;
		}
		return _BTGAssignToGroup = getPersistenceContext().getValue(BTGASSIGNTOGROUP, _BTGAssignToGroup);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>UserGroup.BTGAssignToGroup</code> attribute defined at extension <code>btg</code>. 
	 *  
	 * @param value the BTGAssignToGroup
	 */
	public void setBTGAssignToGroup(final Collection<BTGAssignToGroupDefinitionModel> value)
	{
		_BTGAssignToGroup = getPersistenceContext().setValue(BTGASSIGNTOGROUP, value);
	}
