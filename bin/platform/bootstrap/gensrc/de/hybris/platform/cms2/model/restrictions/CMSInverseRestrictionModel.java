...
public class CMSInverseRestrictionModel extends AbstractRestrictionModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>CMSInverseRestriction.originalRestriction</code> attribute defined at extension <code>cms2</code>. */
	private AbstractRestrictionModel _originalRestriction;
	...
	{
		if (this._originalRestriction!=null)
		{
			return _originalRestriction;
		}
		return _originalRestriction = getPersistenceContext().getValue(ORIGINALRESTRICTION, _originalRestriction);
	}
	...
	{
		_originalRestriction = getPersistenceContext().setValue(ORIGINALRESTRICTION, value);
	}
