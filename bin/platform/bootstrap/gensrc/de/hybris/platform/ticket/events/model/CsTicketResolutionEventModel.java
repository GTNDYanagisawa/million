...
public class CsTicketResolutionEventModel extends CsCustomerEventModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>CsTicketResolutionEvent.resolutionType</code> attribute defined at extension <code>ticketsystem</code>. */
	private CsResolutionType _resolutionType;
	...
	{
		if (this._resolutionType!=null)
		{
			return _resolutionType;
		}
		return _resolutionType = getPersistenceContext().getValue(RESOLUTIONTYPE, _resolutionType);
	}
	...
	{
		_resolutionType = getPersistenceContext().setValue(RESOLUTIONTYPE, value);
	}
