...
public class ReplyModel extends AbstractCommentModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Reply.printJobDecision</code> attribute defined at extension <code>print</code>. */
	public static final String PRINTJOBDECISION = "printJobDecision";
	...
	/** <i>Generated variable</i> - Variable of <code>Reply.printJobDecision</code> attribute defined at extension <code>print</code>. */
	private WorkflowDecisionModel _printJobDecision;
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Reply.printJobDecision</code> attribute defined at extension <code>print</code>. 
	 * @return the printJobDecision
	 */
	public WorkflowDecisionModel getPrintJobDecision()
	{
		if (this._printJobDecision!=null)
		{
			return _printJobDecision;
		}
		return _printJobDecision = getPersistenceContext().getValue(PRINTJOBDECISION, _printJobDecision);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Reply.printJobDecision</code> attribute defined at extension <code>print</code>. 
	 *  
	 * @param value the printJobDecision
	 */
	public void setPrintJobDecision(final WorkflowDecisionModel value)
	{
		_printJobDecision = getPersistenceContext().setValue(PRINTJOBDECISION, value);
	}
