...
public class ClassificationImportJobModel extends ImpExImportJobModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "ClassificationImportJob";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public ClassificationImportJobModel()
	{
		super();
	}
	 ...
	 */
	public ClassificationImportJobModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public ClassificationImportJobModel(final String _code)
	{
		super();
		setCode(_code);
	}
	 ...
	 */
	@Deprecated
	public ClassificationImportJobModel(final String _code, final Integer _nodeID, final ItemModel _owner)
	{
		super();
		setCode(_code);
		setNodeID(_nodeID);
