...
public class CatalogVersionModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>CatalogVersion.importedVersions</code> attribute defined at extension <code>bmecat</code>. */
	public static final String IMPORTEDVERSIONS = "importedVersions";
	...
	/** <i>Generated variable</i> - Variable of <code>CatalogVersion.importedVersions</code> attribute defined at extension <code>bmecat</code>. */
	private Map<String,Integer> _importedVersions;
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CatalogVersion.importedVersions</code> attribute defined at extension <code>bmecat</code>. 
	 * @return the importedVersions
	 */
	public Map<String,Integer> getImportedVersions()
	{
		if (this._importedVersions!=null)
		{
			return _importedVersions;
		}
		return _importedVersions = getPersistenceContext().getValue(IMPORTEDVERSIONS, _importedVersions);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>CatalogVersion.importedVersions</code> attribute defined at extension <code>bmecat</code>. 
	 *  
	 * @param value the importedVersions
	 */
	public void setImportedVersions(final Map<String,Integer> value)
	{
		_importedVersions = getPersistenceContext().setValue(IMPORTEDVERSIONS, value);
	}
