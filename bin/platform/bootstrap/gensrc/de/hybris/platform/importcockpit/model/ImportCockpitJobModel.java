...
public class ImportCockpitJobModel extends ImpExImportJobModel
{
	/**<i>Generated model type code constant.</i>*/
	public final static String _TYPECODE = "ImportCockpitJob";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public ImportCockpitJobModel()
	{
		super();
	}
	 ...
	 */
	public ImportCockpitJobModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public ImportCockpitJobModel(final String _code)
	{
		super();
		setCode(_code);
	}
	 ...
	 */
	@Deprecated
	public ImportCockpitJobModel(final String _code, final Integer _nodeID, final ItemModel _owner)
	{
		super();
		setCode(_code);
		setNodeID(_nodeID);
