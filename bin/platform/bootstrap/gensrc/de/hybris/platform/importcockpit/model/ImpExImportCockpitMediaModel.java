...
public class ImpExImportCockpitMediaModel extends ImpExMediaModel
{
	...
	public final static String _TYPECODE = "ImpExImportCockpitMedia";
	 ...
	 */
	public ImpExImportCockpitMediaModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public ImpExImportCockpitMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final int _linesToSkip, final boolean _removeOnSuccess)
	{
		super();
	 ...
	 */
	@Deprecated
	public ImpExImportCockpitMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final int _linesToSkip, final ItemModel _owner, final boolean _removeOnSuccess)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
