...
public class ProductBOGOFPromotionModel extends ProductPromotionModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>ProductBOGOFPromotion.qualifyingCount</code> attribute defined at extension <code>promotions</code>. */
	private Integer _qualifyingCount;
	
	/** <i>Generated variable</i> - Variable of <code>ProductBOGOFPromotion.freeCount</code> attribute defined at extension <code>promotions</code>. */
	private Integer _freeCount;
	...
	{
		if (this._freeCount!=null)
		{
			return _freeCount;
		}
		return _freeCount = getPersistenceContext().getValue(FREECOUNT, _freeCount);
	}
	...
	{
		_freeCount = getPersistenceContext().setValue(FREECOUNT, value);
	}
