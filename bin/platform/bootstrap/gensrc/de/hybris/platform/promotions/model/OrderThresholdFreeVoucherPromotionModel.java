...
public class OrderThresholdFreeVoucherPromotionModel extends OrderPromotionModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>OrderThresholdFreeVoucherPromotion.thresholdTotals</code> attribute defined at extension <code>promotions</code>. */
	private Collection<PromotionPriceRowModel> _thresholdTotals;
	
	/** <i>Generated variable</i> - Variable of <code>OrderThresholdFreeVoucherPromotion.freeVoucher</code> attribute defined at extension <code>promotions</code>. */
	private VoucherModel _freeVoucher;
	...
	{
		if (this._freeVoucher!=null)
		{
			return _freeVoucher;
		}
		return _freeVoucher = getPersistenceContext().getValue(FREEVOUCHER, _freeVoucher);
	}
	...
	{
		_freeVoucher = getPersistenceContext().setValue(FREEVOUCHER, value);
	}
