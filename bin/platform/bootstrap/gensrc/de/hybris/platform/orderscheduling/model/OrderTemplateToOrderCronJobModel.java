...
public class OrderTemplateToOrderCronJobModel extends CronJobModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>OrderTemplateToOrderCronJob.orderTemplate</code> attribute defined at extension <code>basecommerce</code>. */
	private OrderModel _orderTemplate;
	...
	{
		if (this._orderTemplate!=null)
		{
			return _orderTemplate;
		}
		return _orderTemplate = getPersistenceContext().getValue(ORDERTEMPLATE, _orderTemplate);
	}
	...
	{
		_orderTemplate = getPersistenceContext().setValue(ORDERTEMPLATE, value);
	}
