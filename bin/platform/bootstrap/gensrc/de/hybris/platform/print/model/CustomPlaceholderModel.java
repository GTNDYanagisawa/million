...
public class CustomPlaceholderModel extends PlaceholderModel
{
	...
	public final static String _TYPECODE = "CustomPlaceholder";
	 ...
	 */
	public CustomPlaceholderModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public CustomPlaceholderModel(final CometConfigurationModel _cometConfig, final String _qualifier)
	{
		super();
	 ...
	 */
	@Deprecated
	public CustomPlaceholderModel(final CometConfigurationModel _cometConfig, final ItemModel _owner, final String _qualifier)
	{
		super();
		setCometConfig(_cometConfig);
		setOwner(_owner);
