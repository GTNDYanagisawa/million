	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT0-JOB1/source/entitlementatddtests/genresources/robottests/Entitlement_CreateAndVerifyXML_WithoutCondition_Test.txt"));
		}
