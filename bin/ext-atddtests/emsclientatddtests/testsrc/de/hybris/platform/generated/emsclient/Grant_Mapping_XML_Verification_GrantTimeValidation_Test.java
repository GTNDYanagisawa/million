	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-ENT0-JOB1/source/emsclientatddtests/genresources/robottests/Grant_Mapping_XML_Verification_GrantTimeValidation_Test.txt"));
		}
