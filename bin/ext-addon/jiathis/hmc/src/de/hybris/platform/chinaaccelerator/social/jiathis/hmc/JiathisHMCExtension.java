 ...
 *  
 */
package de.hybris.platform.chinaaccelerator.social.jiathis.hmc;
...
/**
 * Provides necessary meta information about the jiathis hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0-SNAPSHOT
 */
public class JiathisHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(JiathisHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.hybris.social.jiathis.hmc.locales";
