...
public class ChinastoreelectronicsManager extends GeneratedChinastoreelectronicsManager
{
	...
	{
		return (ChinastoreelectronicsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinastoreelectronicsConstants.EXTENSIONNAME);
	}
